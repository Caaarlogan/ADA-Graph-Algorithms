...
public class AdjacencyListGraph<E> implements GraphADT<E>
{
   ...
   {  this(GraphADT.GraphType.UNDIRECTED);
   }
   ...
   public GraphADT.GraphType getType()
   {  return type;
   }
   ...
   {  // first add the end vertices if not already in graph
      ...
      if (type == GraphADT.GraphType.UNDIRECTED) // add the reverse edge 
   ...
   {  if (!containsVertex(vertex))
      ...
      {  // first remove all incident edges
         ...
         {  Edge<F> edgeToRemove = edgeIterator.next();
            ...
            if (type == GraphADT.GraphType.UNDIRECTED) // remove reverse edge 
